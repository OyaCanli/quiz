...
class QuizPresenter @Inject constructor(
        ...
        val randomOptionGenerator : IRandomOptionGenerator
    ...
    @VisibleForTesting(otherwise = VisibleForTesting.PRIVATE)
    var optionsToErase: ArrayList<Option> = ArrayList()
   ...
   override var isSubmitted : Boolean = false
    ...
    override fun onHalfClicked() {
        ...
        optionsToErase = randomOptionGenerator.getRandomOptionsToErase(currentQuestion)
